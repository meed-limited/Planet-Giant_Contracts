...
// const recipient: string = "0xf6816299A0Fb350A035e502E88Af61C9B3d22192"; // Paul
const recipient: string = "0xF0eEaAB7153Ff42849aCb0E817efEe09fb078C1b"; // Perso
const amount: number = 5;

async function main() {
  const NFT = await ethers.getContractFactory("NFT");
  const nft = await NFT.deploy(recipient, amount);
  await nft.deployed();
  ...
  await hre.run("verify:verify", {
    address: nft.address,
    constructorArguments: [recipient, amount],
  });
